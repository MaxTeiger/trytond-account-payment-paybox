...
setup(name=name,
    ...
    packages=find_packages(exclude=['*.modules.*', 'modules.*', 'modulversion = '%s.%s.dev0' % (major_version, minor_version)
...
setup(name=name,
    ...
    python_requires='>=3.4',
    install_requires=[
        'trytond-account-payment@git+https://github.com/coopengo/account_payment',
        ],
    extras_require={
